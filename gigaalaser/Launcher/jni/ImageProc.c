...
int initdevice(void) 
{
	...
	//set v4l2_standard
	//V4L2_STD_525_60 NTSC
	//V4L2_STD_625_50 PAL
	//std_id = V4L2_STD_625_50;
	if(video_format == V_NTSC){
...
void processimage (const void *p)
{
		...
		uyvy422toABGRY((unsigned char *)p);
}
...
void uyvy422toABGRY(unsigned char *src)
{
...
void 
Java_cn_com_gigaalaser_launcher_LauncherSurfaceView_pixeltobmp( JNIEnv* env,jobject thiz,jobject bitmap){
...
jint 
Java_cn_com_gigaalaser_launcher_LauncherSurfaceView_prepareCamera( JNIEnv* env,jobject thiz, jint videoid, jint format, jint width, jint height){
...
void 
Java_cn_com_gigaalaser_launcher_LauncherSurfaceView_processCamera( JNIEnv* env,
										jobject thiz){
...
void 
Java_cn_com_gigaalaser_launcher_LauncherSurfaceView_stopCamera(JNIEnv* env,jobject thiz){
